...
const baseMessages = [
  {
    id: 1,
    author: "me",
    text: "Hi, our first message on this awesome app :) !",
  },
  ...
  return (
    <>
      <div className="flex">
        ...
        <article className="h-screen flex flex-col w-full">
          ...
          <div className="flex flex-col flex-1 overflow-hidden">
            ...
            >
              ...
              <button
                type="submit"
                className="rounded-full p-2 bg-gradient-to-r from-[#A18CD1] via-[#CEA7DE] to-[#FBC2EB] shadow-md"
              >
